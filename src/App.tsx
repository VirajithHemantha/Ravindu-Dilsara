...
/**
 * Premium Kandy Road, Kalagedihena, Sri Lankan Wedding Invitation Theme
...
function CountdownTimer() {
  const targetDate = new Date("August 06, 2026 08:00:00").getTime();
      ...
      {stats.map((stat, i) => (
        ...
        >
          ...
          <div className="relative w-[5.5rem] h-[7.5rem] sm:w-20 sm:h-28 md:w-32 md:h-44 bg-white rounded-t-full shadow-[0_15px_35px_-10px_rgba(0,0,0,0.08)] border border-theme-100/60 flex flex-col items-center justify-center overflow-hidden transition-transform duration-700 group-hover:-translate-y-3">
            ...
            {/* The Number */}
            <span className="text-3xl sm:text-3xl md:text-5xl font-allura text-theme-800 leading-none relative z-10 drop-shadow-sm mt-4 sm:mt-4 md:mt-6 transition-transform duration-500 group-hover:scale-110">
...
function WeddingTimeline() {
  const schedule = [
    { time: "08:00 AM", event: "Guest Arrival", icon: <Sparkles className="w-4 h-4" /> },
    { time: "08:30 AM", event: "Welcome & Seating", icon: <MapPin className="w-4 h-4" /> },
    { time: "08:43 AM", event: "Poruwa Ceremony", icon: <Clock className="w-4 h-4" /> },
    { time: "10:00 AM", event: "Family Photography Session", icon: <Sparkles className="w-4 h-4" /> },
    { time: "12:00 PM", event: "Lunch Reception", icon: <Clock className="w-4 h-4" /> },
    { time: "02:00 PM", event: "Going Away Celebration", icon: <MapPin className="w-4 h-4" /> },
    { time: "04:00 PM", event: "Event Concludes", icon: <Sparkles className="w-4 h-4" /> },
  ];
    ...
    <section className="cv-auto py-24 md:py-36 bg-white relative overflow-hidden flex flex-col items-center">
      ...
      <div className="max-w-4xl w-full px-4 relative z-10">
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2 className="font-allura text-[3.5rem] md:text-[5.5rem] text-theme-900 leading-none">Wedding Timeline</h2>
        </div>
                ...
                <div className={`flex-1 ml-12 md:ml-0 ${index % 2 === 0 ? "md:text-right" : "md:text-left"}`}>
                  <div className={`inline-block p-4 sm:p-6 bg-[#faf9f6]/80 backdrop-blur-sm border border-theme-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow max-w-sm w-full ${index % 2 === 0 ? "md:mr-[-10px]" : "md:ml-[-10px]"}`}>
                    <div className={`flex items-center gap-4 mb-2 ${index % 2 === 0 ? "md:flex-row-reverse" : "md:flex-row"}`}>
                      ...
                      <span className="text-[10px] md:text-[12px] font-bold text-theme-700 tracking-[0.2em] font-playfair">{item.time}</span>
                    </div>
                    <h4 className="text-lg md:text-2xl font-allura text-stone-800">{item.event}</h4>
                  </div>
                </div>
...
function WeddingInvitation() {
  ...
  const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxmFarjWigx1zBFZLr7-HgrpGmCmAISCwU0EpGwUb2gHD4qazSSi3gYy6Dh2oWlFkvk/exec";
        ...
        {!isOpened ? (
          ...
          >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
              ...
              <h1 className="font-playfair text-4xl md:text-5xl text-stone-800 mb-4 tracking-tight">
                {guestName ? guestName : "Dilsara & Ravindu"}
              </h1>
              <p className="text-stone-500 text-sm tracking-[0.2em] font-light">
                {guestName ? "ARE CORDIALLY INVITED" : "06 AUGUST 2026"}
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="text-center relative z-10">
                  <p className="font-playfair text-[1.7rem] font-bold text-stone-800 leading-none">D&R</p>
          ...
          >
            ...
            <section className="min-h-[100dvh] w-full flex items-center justify-center p-4 md:p-12 relative overflow-hidden bg-[#faf9f6]">
              ...
              <motion.div
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-playfair text-[40vw] text-theme-900 pointer-events-none whitespace-nowrap leading-none select-none z-0"
              >
                D&R
              </motion.div>
                ...
                <div className="flex flex-col items-center text-center space-y-4 flex-1 w-full relative z-10">
                  ...
                  <div className="space-y-0 py-4 flex-1 flex flex-col justify-center">
                    <motion.h1
                      ...
                      className="font-allura text-[3rem] sm:text-[3.5rem] md:text-[5.5rem] text-stone-800 leading-[1.1] drop-shadow-sm"
                    >
                      Dilsara
                    </motion.h1>
                    <motion.div
                      ...
                      className="font-allura text-3xl md:text-5xl text-theme-500 italic font-light my-2 md:my-4 tracking-widest"
                    >
                      &
                    </motion.div>
                    <motion.h1
                      ...
                      className="font-allura text-[3rem] sm:text-[3.5rem] md:text-[5rem] text-stone-800 leading-[1.1] drop-shadow-sm"
                    >
                      Ravindu
                    </motion.h1>
                  </div>
                  ...
                  >
                    ...
                    <div className="font-playfair space-y-1">
                      <p className="text-2xl md:text-4xl text-stone-700 tracking-[0.2em] md:tracking-[0.3em] font-bold">06 AUGUST 2026</p>
                      <p className="text-xs md:text-sm text-theme-600 tracking-[0.2em] uppercase font-bold">The Glasgow (Crystal Ballroom)</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
            ...
            {/* Elegant Pre-shoot Photo Section */}
            <section className="w-full py-16 md:py-24 bg-[#faf9f6] relative flex flex-col items-center justify-center overflow-hidden">
               <div className="absolute inset-0 opacity-[0.03] paper-grain pointer-events-none" />
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] aspect-square bg-theme-200 blur-[120px] rounded-full opacity-20 pointer-events-none" />
               ...
               <motion.div 
                 ...
                 className="relative w-[90vw] max-w-[1000px] aspect-[4/5] md:aspect-[21/9] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-[0_20px_50px_-15px_rgba(0,0,0,0.2)] border-8 md:border-[16px] border-white group z-10"
               >
                 <img src="/preshoot.jpeg" alt="Dilsara & Ravindu" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-[2s] ease-in-out" />
                 ...
                 <div className="absolute inset-0 flex flex-col items-center justify-end pb-12 md:pb-16 px-4">
                    ...
                    >
                      <div className="flex items-center gap-4 justify-center mb-4 md:mb-6">
                        <div className="h-px w-12 md:w-20 bg-gradient-to-r from-transparent to-white/80" />
                        <Sparkles className="w-4 h-4 md:w-5 md:h-5 text-white/90" />
                        <div className="h-px w-12 md:w-20 bg-gradient-to-l from-transparent to-white/80" />
                      </div>
                      <h2 className="font-allura text-4xl md:text-6xl lg:text-7xl text-white tracking-wide drop-shadow-md">
                        A Love Story
                      </h2>
                      <p className="mt-2 md:mt-4 text-[10px] md:text-xs uppercase tracking-[0.4em] md:tracking-[0.6em] text-white/80 font-bold">
              ...
              <div className="max-w-[1000px] w-full flex flex-col items-center text-center relative z-10">
                ...
                <div className="relative w-full flex flex-col md:flex-row items-center justify-center md:items-stretch gap-6 md:gap-10 my-12 md:my-20 z-10 px-2 lg:px-8">
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-playfair text-stone-600 tracking-wide leading-relaxed">Late Mr. Pieris &<br />Mrs. Hendawitharana</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-allura text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Dilsara</h3>
                    </div>
                  </motion.div>
                  ...
                  <div className="flex flex-row md:flex-col items-center justify-center gap-4 py-4 md:py-0 relative z-20">
                    ...
                    >
                      <span className="text-3xl md:text-5xl font-allura text-white md:-mt-1 drop-shadow-md">&</span>
                    </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-playfair text-stone-600 tracking-wide leading-relaxed">Mr. &<br />Mrs. Senevirathne</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-allura text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Ravindu</h3>
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-32 text-center w-full max-w-4xl px-4">
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-stone-400 font-bold mb-3">On</p>
                      <p className="font-playfair text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">THURSDAY, 06 AUGUST</p>
                      <p className="font-playfair text-lg md:text-xl text-theme-600 tracking-[0.3em] font-normal mt-2">2026</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-stone-400 font-bold mb-3">At</p>
                      <p className="font-playfair text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">08:00 AM</p>
                      <p className="font-playfair text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap mt-2">To 04:00 PM</p>
                    </div>
                  </div>
                  ...
                  <div className="pt-8 w-full px-4">
                    <div className="relative inline-flex items-center justify-center w-full max-w-md mx-auto group">
                      ...
                      <p className="relative text-stone-900 bg-white shadow-[0_4px_20px_-5px_rgba(0,0,0,0.05)] text-[9px] md:text-[11px] font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase px-6 lg:px-10 py-4 lg:py-5 rounded-3xl md:rounded-full border border-theme-300 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 w-full md:w-auto">
                        ...
                        <span className="text-center md:whitespace-nowrap leading-relaxed">Poruwa Ceremony<br className="md:hidden" /> 8:43 AM</span>
                        <span className="hidden md:block w-1.5 h-1.5 rotate-45 bg-theme-500 shrink-0" />
                      </p>
                    </div>
                  </div>
            ...
            <section className="cv-auto py-16 md:py-36 bg-[#faf9f6] relative border-y border-theme-100/30 flex flex-col items-center overflow-hidden">
              ...
              <div className="w-full max-w-[1000px] px-4 flex flex-col items-center text-center relative z-10">
                ...
                >
                  {/* Watermark text */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-allura text-[12vw] md:text-[140px] text-theme-100/50 whitespace-nowrap pointer-events-none z-0 select-none">
                    Forever
                  </div>
                  ...
                  <h2 className="font-playfair text-3xl md:text-5xl text-theme-900 mb-8 relative z-10 tracking-widest font-bold drop-shadow-sm px-4 leading-[1.4]">
                    Wait for the <span className="font-allura text-theme-700 italic lowercase tracking-normal text-4xl md:text-7xl ml-2">magic</span>
                  </h2>
                ...
                <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                  ...
                  >
                    <div className="flex flex-col items-start gap-4">
                      ...
                      <h2 className="font-allura text-[3.5rem] sm:text-[4rem] md:text-[5.5rem] text-theme-900 leading-[1] drop-shadow-sm ml-[-4px]">
                        The Glasgow (Crystal Ballroom)
                      </h2>
                    </div>
                    ...
                    <div className="space-y-6 pt-4 relative">
                      ...
                      <div className="pl-8 space-y-4">
                        ...
                        <p className="text-lg md:text-xl text-stone-700 font-playfair font-medium leading-relaxed tracking-wide">
                          No. 39/51, Pelahela Estate,<br />Kandy Road, Kalagedihena,<br />Sri Lanka
                        </p>
                      </div>
                    ...
                    <div className="pt-8 w-full md:w-auto">
                      <button
                        onClick={() => window.open('https://www.google.com/maps/search/The+Glasgow+(Crystal+Ballroom)+Kalagedihena', '_blank')}
                  ...
                  >
                    ...
                    <div className="absolute inset-0 w-full h-full scale-[1.2] group-hover:scale-[1.15] transition-transform duration-[2s]">
                      <iframe
                        src="https://maps.google.com/maps?q=The%20Glasgow%20(Crystal%20Ballroom)%20Kalagedihena&t=&z=14&ie=UTF8&iwloc=&output=embed"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        allowFullScreen
            ...
            <section className="cv-auto py-24 md:py-36 bg-[#1a1917] text-white relative overflow-hidden flex flex-col items-center">
              ...
              <div className="container mx-auto px-4 max-w-2xl text-center relative z-10 w-full">
                ...
                >
                  ...
                  <h2 className="font-allura text-[3.5rem] sm:text-[4rem] md:text-[5.5rem] text-white mb-6 drop-shadow-md">RSVP</h2>
                  ...
                  <p className="text-stone-300 text-sm md:text-base max-w-md mx-auto leading-relaxed mb-8 tracking-wide font-light">
                    We would be absolutely thrilled to celebrate with you. Kindly respond by July 25th.
                  </p>
                  <div className="flex justify-center gap-8 mb-12 font-playfair text-theme-200 text-sm font-bold">
                    <p>Dilsara: +94 71 668 4153</p>
                    <p>Ravindu: +94 71 841 5303</p>
                  </div>
                  ...
                  <div className="w-full bg-white/5 backdrop-blur-md p-6 sm:p-8 md:p-12 rounded-[2rem] border border-white/10 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)]">
                    {submitted.rsvp ? (
                      ...
                      >
                        ...
                        <h3 className="font-allura text-3xl text-white">Thank You!</h3>
                      ...
                      <form className="space-y-8 text-left" onSubmit={handleRSVPSubmit}>
                        <div className="space-y-3">
                          ...
                          <input
                            ...
                            className="w-full bg-transparent border-b border-white/20 px-2 py-3 text-white placeholder:text-white/30 focus:outline-none focus:border-theme-300 transition-colors font-playfair text-lg md:text-xl tracking-wide"
                          />
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="relative">
                            <select
                              ...
                              className="w-full bg-transparent border-b border-white/20 px-2 py-3 text-white focus:outline-none focus:border-theme-300 transition-colors font-playfair text-lg md:text-xl tracking-wide appearance-none cursor-pointer"
                            >
            ...
            <div className="relative bg-[#faf9f6]">
              ...
              <section className="cv-auto py-24 md:py-36 relative flex flex-col items-center overflow-hidden">
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    ...
                    <h2 className="font-allura text-[3.5rem] sm:text-[4rem] md:text-[5.5rem] text-theme-800 mb-6 drop-shadow-sm leading-none">Best Wishes</h2>
                    ...
                    <div className="w-full max-w-2xl mx-auto bg-white p-6 sm:p-8 md:p-14 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border border-theme-100/50 rounded-tr-[4rem] rounded-bl-[4rem] relative group">
                      ...
                      {submitted.wish ? (
                        ...
                        >
                          <div className="w-16 h-16 bg-theme-600 rounded-full flex items-center justify-center text-white text-2xl">✓</div>
                          <h3 className="font-allura text-4xl text-theme-900">Sweet Wishes Received!</h3>
                        ...
                        <form className="space-y-8 text-left relative z-10" onSubmit={handleWishSubmit}>
                          <div className="space-y-3">
                            ...
                            <input
                              ...
                              className="w-full bg-stone-50/50 border-b border-theme-200 px-4 py-4 text-theme-900 placeholder:text-stone-300 focus:outline-none focus:border-theme-400 focus:bg-white transition-all font-playfair text-lg tracking-wide rounded-t-lg"
                            />
                          </div>
                          <div className="space-y-3">
                            ...
                            <textarea
                              ...
                              className="w-full bg-stone-50/50 border-b border-theme-200 px-4 py-4 text-theme-900 placeholder:text-stone-300 focus:outline-none focus:border-theme-400 focus:bg-white transition-all font-playfair text-lg tracking-wide resize-none rounded-t-lg"
                            />
                          </div>
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-allura text-[22vw] md:text-[220px] text-theme-100/40 whitespace-nowrap pointer-events-none z-0 select-none">
                        Thank You
                      </div>
                      ...
                      <h3 className="font-allura text-[3.2rem] sm:text-6xl md:text-8xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-4 leading-none">Dilsara & Ravindu</h3>
              ...
              <footer className="py-12 border-t border-theme-200/30 text-center relative z-10 space-y-3">
                <p className="text-[8px] md:text-[10px] uppercase tracking-[0.5em] text-stone-400 font-bold">
                  © 2026 Dilsara & Ravindu. <span className="hidden md:inline">|</span><br className="md:hidden block mt-2" /> All rights reserved.
                </p>
    ...
    <div className="min-h-screen bg-[#faf9f6] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="font-playfair text-2xl text-stone-800">Link Generator</h1>
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-1 space-y-2">
              ...
              <select
                ...
                className="w-full bg-stone-50 border border-theme-100 p-4 rounded-xl focus:outline-none focus:border-theme-400 font-playfair text-sm"
              >
                <option>Mr.</option>
                <option>Mrs.</option>
                <option>Ms.</option>
            ...
            <div className="col-span-2 space-y-2">
              ...
              <input
                ...
                className="w-full bg-stone-50 border border-theme-100 p-4 rounded-xl focus:outline-none focus:border-theme-400 font-playfair"
              />
            </div>
          </div>
          ...
          <div className="p-6 bg-theme-50 rounded-2xl border border-theme-100 space-y-4">
            ...
            <div className="text-center space-y-2 py-4 bg-white/50 rounded-xl border border-white/80">
              ...
              <h3 className="font-playfair text-xl text-stone-800">{guestName || "Guest Name"}</h3>
